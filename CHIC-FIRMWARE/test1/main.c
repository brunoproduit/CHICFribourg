    ...
    switch (p_ble_evt->header.evt_id)
        ...
        case BLE_GAP_EVT_DISCONNECTED:
            ...
            break;
				...
				case 0x0C:
						sd_ble_gattc_read(m_conn_handle, BLE_CONN_HANDLE_ALL, 0);
						//sd_ble_gatts_value_get(BLE_GATTS_EVT_WRITE, BLE_GATTS_EVT_WRITE,)
						break;

        default:
            //m_conn_handle = p_ble_evt->evt.gattc_evt.conn_handle;// No implementation needed.
            break;
    }
}
