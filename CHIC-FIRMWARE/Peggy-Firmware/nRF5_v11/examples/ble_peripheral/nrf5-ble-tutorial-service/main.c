...
static ble_os_t m_our_service; // STEP 1: Declare a ble_os_t service structure for our application
...
{
    our_service_init(&m_our_service);	// STEP 2: Add code to initialize the services used by the application.
}
