...
#define MANUFACTURER_NAME                "HEIA-FR"                      						/**< Manufacturer. Will be passed to Device Information Service. */
...
#define	DEBOUNCE_INTERVAL								 APP_TIMER_TICKS(100, APP_TIMER_PRESCALER) 	/**<	Analog input disable intervall*/
...
{
		NRF_GPIO->OUTCLR = (BSP_LED_1_MASK | BSP_LED_2_MASK | BSP_LED_3_MASK | BSP_LED_4_MASK | BSP_LED_5_MASK | BSP_LED_6_MASK);
	
		switch(current_sensor)
		{
			case 1:							// first Sensor
				notify_coin(4);	// -.50 CHF
				break;
			case 2:							// 2nd sensor
				notify_coin(1);	// -.10 CHF
				break;
			case 3:							// 3rd sensor
				notify_coin(2);	// -.20 CHF
				break;
			case 4:							// 4th sensor
				notify_coin(8);	// 1.- CHF
				break;
			case 5:							// 5th sensor
				notify_coin(16);// 2.- CHF
				break;
			case 0:							// 6th sensor
				notify_coin(32);// 5.- CHF
				break;
			default:
				break;
		}
...
// A3 event handler
static void A5_event_handler(nrf_lpcomp_event_t event){
...
// A5 LPCOMP config
static nrf_drv_lpcomp_config_t m_lpcomp_AIN5 = {{NRF_LPCOMP_REF_SUPPLY_5_8 , NRF_LPCOMP_DETECT_UP},
																								NRF_LPCOMP_INPUT_5,
...
static void lpcomp_init(void)
{
    ...
    //err_code = nrf_drv_lpcomp_init(NULL, lpcomp_event_handler);
		err_code = nrf_drv_lpcomp_init(&m_lpcomp_AIN5, A5_event_handler);
    APP_ERROR_CHECK(err_code);
    nrf_drv_lpcomp_enable();
}
