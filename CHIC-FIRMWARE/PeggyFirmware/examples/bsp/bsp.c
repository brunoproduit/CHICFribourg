...
#define CRITICAL_ERROR_LED_INTERVAL      			 1000
...
static const app_button_cfg_t app_buttons[BUTTONS_NUMBER] =
{
    ...
    #ifdef BSP_BUTTON_3
    {BSP_BUTTON_3, APP_BUTTON_ACTIVE_LOW, BUTTON_PULLDOWN, bsp_button_event_handler},
    #endif // BUTTON_3

    #ifdef BSP_BUTTON_4
    {BSP_BUTTON_4, APP_BUTTON_ACTIVE_LOW, BUTTON_PULLDOWN, bsp_button_event_handler},
    #endif // BUTTON_4

    #ifdef BSP_BUTTON_5
    {BSP_BUTTON_5, APP_BUTTON_ACTIVE_LOW, BUTTON_PULLDOWN, bsp_button_event_handler},
    #endif // BUTTON_5

    #ifdef BSP_BUTTON_6
    {BSP_BUTTON_6, APP_BUTTON_ACTIVE_LOW, BUTTON_PULLDOWN, bsp_button_event_handler},
    #endif // BUTTON_6

    #ifdef BSP_BUTTON_7
    {BSP_BUTTON_7, APP_BUTTON_ACTIVE_LOW, BUTTON_PULLDOWN, bsp_button_event_handler},
    #endif // BUTTON_7
		
		#ifdef BSP_BUTTON_8
    {BSP_BUTTON_8, APP_BUTTON_ACTIVE_LOW, BUTTON_PULLDOWN, bsp_button_event_handler},
    #endif // BUTTON_8
};
#endif // BSP_SIMPLE
...
static uint32_t bsp_led_indication(bsp_indication_t indicate)
{
    ...
    switch (indicate)
    {
        ...
        case BSP_INDICATE_ADVERTISING:
						if(((BSP_LED_0_MASK) & NRF_GPIO->OUT))
						{
						...
						{
							NRF_GPIO->OUTSET = BSP_LED_0_MASK;
							next_delay = indicate ==
