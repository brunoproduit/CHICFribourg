...
#define BOOTLOADER_BUTTON               BSP_BUTTON_1 //3                                            /**< Button used to enter SW update mode. */
#define UPDATE_IN_PROGRESS_LED          BSP_LED_1    //2                                           /**< Led used to indicate that DFU is active. */
...
int main(void)
{
    ...
    dfu_start  = app_reset;
    //dfu_start |= ((nrf_gpio_pin_read(BOOTLOADER_BUTTON) == 0) ? true: false);			//uncommented to disable hardware entry of DFU
